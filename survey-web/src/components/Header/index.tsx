...
class HeaderComponent extends React.Component<Props, State> {
      ...
      <>
        ...
        <Drawer className={classes.drawer} classes={{ paper: classes.drawerPaper }} anchor="left" open={open}>
          ...
          <List>
            ...
            <ListItem onClick={this.redirectToReviews} button>
              <ListItemText primary="Performance reviews" />
            </ListItem>
            <ListItem onClick={this.redirectToReviewees} button>
              <ListItemText primary="Reviewees" />
            </ListItem>
          </List>
        </Drawer>
      </>
  ...
  protected redirectToReviewees() {
    window.location.href = '/reviewees';
  }
